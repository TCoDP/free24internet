...
export default async function EnAdminMonetaPage({ searchParams }: Props) {
    ...
    <div className="space-y-6">
      ...
      {loadError ? (
        <p className="text-sm text-slate-600">
          No data, or the <code className="rounded bg-slate-100 px-1">moneta_checkout_sessions</code> table is not
          created yet (migration 009).
        </p>
      ) : null}
