...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Пользовательское соглашение — Свободный Интернет",
        ...
        <div className="mx-auto w-full max-w-[1000px]">
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm md:p-12">
            <div className="prose max-w-none space-y-6 text-slate-600">
              <h3 className="mt-4 text-xl font-bold text-dark">1. Общие положения</h3>
              <p>
              ...
              <h3 className="mt-8 text-xl font-bold text-dark">2. Характер услуг и цифровых товаров</h3>
              <p>
              ...
              <h3 className="mt-8 text-xl font-bold text-dark">3. Отказ от гарантий и ответственности</h3>
              ...
              <h3 className="mt-8 text-xl font-bold text-dark">4. Законность использования</h3>
              <p>
              ...
              <h3 className="mt-8 text-xl font-bold text-dark">5. Интеллектуальная собственность</h3>
              <p>
              ...
              <h3 className="mt-8 text-xl font-bold text-dark">6. Ограничение доступа</h3>
              <p>
              ...
              <h3 className="mt-8 text-xl font-bold text-dark">7. Платежи и возвраты</h3>
              <p>
              ...
              <p>
                ...
                поддержки в течение 24 часов с момента оплаты.
              </p>
              ...
              <h3 className="mt-8 text-xl font-bold text-dark">8. Конфиденциальность</h3>
              <p>
              ...
              <h3 className="mt-8 text-xl font-bold text-dark">9. Изменение условий</h3>
              ...
              <h3 className="mt-8 text-xl font-bold text-dark">10. Контактная информация</h3>
              <p>
                10.1. По всем вопросам Пользователь может обратиться в службу поддержки через форму в
                самом боте.
              </p>
